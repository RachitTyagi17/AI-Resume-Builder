          ...
          {showUploadResume && (
            ...
            >
              <div
                ...
                className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
              >
                <h2 className="text-4xl font-bold mb-4">Upload Resume</h2>
                <input
                  onChange={(e) => setTitle(e.target.value)}
                  value={title}
                  type="text"
                ...
                <div>
                  ...
                  >
                    Select Resume File
                    <div
                      className="flex flex-col items-center justify-center gap-2 border group text-slate-400 border-dashed rounded:md p-4 py-10 my-4 
          ...
          {editResumeId && (
            ...
            >
              <div
                ...
                className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
              >
                <h2 className="text-4xl font-bold mb-4">Edit Resume Title</h2>
                <input
                  onChange={(e) => setTitle(e.target.value)}
                  value={title}
                  type="text"
